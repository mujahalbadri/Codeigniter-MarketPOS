    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item"><a href="<?= site_url('stock/out'); ?>">Stock</a></li>
					<li class="breadcrumb-item"><a href="<?= site_url('stock/out'); ?>">Out</a></li>
				...
				<div class="card">
					...
					<div class="card-header">
						...
						<div class="float-right">
							<a href="<?= site_url('stock/out'); ?>" class="btn btn-warning text-white">
              ...
              <div class="row">
                <div class="col-lg-6 offset-lg-3 col-md-8 offset-md-2">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="item_name" name="item_name" readonly>
									...
									<div class="form-group">
										...
										<input type="text" class="form-control" name="info" id="info" placeholder="Rusak / hilang / kadaluarsa / etc" required>
									</div>
									<div class="form-group">
                  ...
                  <div class="form-group d-flex justify-content-center">
                    <button type="submit" name="out_add" class="btn btn-success btn-md mr-3">Save</button>
