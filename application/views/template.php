...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed ">
  ...
  <div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link" data-widget="pushmenu" href="<?= site_url('dashboard'); ?>" role="button"><i
      ...
      <ul class="navbar-nav ml-auto">
        <li class="nav-item dropdown user user-menu">
          <a href="<?= site_url('dashboard'); ?>" class="nav-link dropdown-toggle" data-toggle="dropdown">
            <img src="<?= base_url('assets'); ?>/dist/img/profile/<?= $this->fungsi->user_login()->image; ?>"
          ...
          <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            ...
            <li class="user-footer">
              ...
              <div class="float-right">
                <a href="<?= site_url('auth/logout'); ?>" class="btn btn-danger" data-toggle="modal"
    ...
    <aside class="main-sidebar sidebar-dark-danger elevation-4">
      ...
      <a href="<?= base_url(); ?>dashboard" class="brand-link">
        <img src="<?= base_url('assets'); ?>/dist/img/market.png" alt="Logo" class="brand-image img-circle elevation-3"
          style="opacity: .8">
      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li
              class="nav-item has-treeview <?= $this->uri->segment(1) == 'category' || $this->uri->segment(1) == 'unit' || $this->uri->segment(1) == 'item' ? 'menu-open' : ''; ?>">
              <a href=""
                class="nav-link <?= $this->uri->segment(1) == 'category' || $this->uri->segment(1) == 'unit' || $this->uri->segment(1) == 'item' ? 'active' : ''; ?>">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="<?= site_url('unit'); ?>"
                    class="nav-link <?= $this->uri->segment(1) == 'unit' ? 'active' : ''; ?>">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Unit</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="<?= site_url('item'); ?>"
                    class="nav-link <?= $this->uri->segment(1) == 'item' ? 'active' : ''; ?>">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Item</p>
                  </a>
                </li>
            ...
            <li
              class="nav-item has-treeview <?= $this->uri->segment(1) == 'stock' ||  $this->uri->segment(1) == 'sale' ? 'menu-open' : ''; ?>">
              <a href=""
                class="nav-link <?= $this->uri->segment(1) == 'stock' ||  $this->uri->segment(1) == 'sale' ? 'active' : ''; ?>">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="<?= site_url('sale'); ?>"
                    class="nav-link <?= $this->uri->segment(1) == 'sale' ? 'active' : ''; ?>">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Sales</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="<?= site_url('stock/in'); ?>"
                    class="nav-link <?= $this->uri->segment(1) == 'stock' && $this->uri->segment(2) == 'in' ? 'active' : ''; ?>">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Stock In</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="<?= site_url('stock/out'); ?>"
                    class="nav-link <?= $this->uri->segment(1) == 'stock' && $this->uri->segment(2) == 'out' ? 'active' : ''; ?>">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Stock Out</p>
                  </a>
                </li>
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="<?= site_url('reports/sales'); ?>"
                    class="nav-link <?= $this->uri->segment(1) == 'reports' && $this->uri->segment(2) == 'sales' ? 'active' : ''; ?>">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Sales</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="<?= site_url('reports/stocks'); ?>"
                    class="nav-link <?= $this->uri->segment(1) == 'reports' && $this->uri->segment(2) == 'stocks' ? 'active' : ''; ?>">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Stocks</p>
                  </a>
                </li>
